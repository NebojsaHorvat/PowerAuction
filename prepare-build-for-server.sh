...
alfa_nodes=("Prosumer" "Producer1" "Prosumer2" "Customer4" "Customer5" "Prosumer6" "Prosumer7" "Prosumer8") 
copy_node_data_localy "${alfa_nodes[@]}" "alfa"

beta_nodes=("Customer" "Producer" "Customer2" "Prosumer3" "Customer6" "Customer8" "Customer9")
copy_node_data_localy "${beta_nodes[@]}" "beta"

gama_nodes=("GridAuthority" "Customer1" "Prosumer4" "Prosumer5" "Customer7" "Customer10" "Customer11")
